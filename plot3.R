...
###                                                                          ###
###                                SCRIPT 3                                  ###
###                 DOWNLOAD, EXTRACT AND TIDY THE DATA SET, THEN,           ###
###                  PLOT A MULTIVARIATE TIME SERIES ABOUT ENERGY            ###
###                         SUBMETERING IN THE HOUSEHOLD                     ###
###                                                                          ###
### This R script downloads and extracts the power consumption data set into ###
### our WORKING directory. If the data set has already been loaded into the  ###
### R environment, it just plots the multivariate time-series into a         ### 
### png-file. Please, make sure you've alredy set your R working directory   ###
### before running the script to facilitate locating the plot file.          ###
###                                                                          ###
################################################################################
